...
router.get('/:id', authenticate, authorizationRole('admin'), ctrl.getReviewTagById);
router.put('/:id', authenticate, authorizationRole('admin'), ctrl.updateReviewTag);
router.delete('/:id', authenticate, authorizationRole('admin'), ctrl.deleteReviewTag);
