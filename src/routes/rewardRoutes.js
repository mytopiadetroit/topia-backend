...
router.post('/claim', authenticate, upload.fields([
...
// Admin routes
router.get('/admin/requests', authenticate, authorizationRole('admin'), getAllRewardRequests);
router.put('/admin/requests/:id', authenticate, authorizationRole('admin'), updateRewardStatus);
router.get('/admin/stats', authenticate, authorizationRole('admin'), getRewardStats);
