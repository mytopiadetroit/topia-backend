...
router.get(
  ...
  reviewController.getProductReviewAggregates,
)
...
router.post(
  ...
  reviewController.createReviewOption,
)
router.put(
  '/:id',
  authenticate,
  authorizationRole('admin'),
  reviewController.updateReviewOption,
)
router.delete(
  '/:id',
  authenticate,
  authorizationRole('admin'),
  reviewController.deleteReviewOption,
)
router.get(
  '/:id',
  authenticate,
  authorizationRole('admin'),
  reviewController.getReviewOptionById,
)
